...
<script>
    ...
    function displayCircleDot(position, distance) {
        ...
        console.log("서클 오버레이"+circleOverlay.setMap(map));
        console.log("되는지도 이제 모르겠다"+circleOverlay);
        if (distance > 0) {
    ...
    //         return { La: latlng.La, Ma: latlng.Ma };
    //     });
    //
    //     console.log("clickInfo start");
    //     console.log(path);
    //
    //     $.ajax({
    //         url: "/clickInfo",
    ...
    //         data: JSON.stringify({ data: path }),  // path를 배열로 직접 전달
...
<div><input type="submit" onclick="return clickInfo()" value="정보보기"></div>
</body>
</html>